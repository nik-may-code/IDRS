...
// const LeaveApplicationForm = ({ facultyId, onNewLeave }) => {
...
//               className="cursor-pointer bg-white py-2 px-3 border border-gray-300 rounded-xl text-sm font-normal text-gray-700 hover:bg-gray-50"
//             >
//               Choose file
//             </label>
//             <input
...
//             />
//             <span className="ml-5 text-sm text-gray-500">{fileName}</span>
//           </div>
//         </div>
...
//             type="submit"
//             disabled={loading}
//             className="inline-flex justify-center py-2 px-4 border border-transparent border-gray-300 text-sm font-normal rounded-xl text-white bg-gray-800 hover:bg-gray-900 disabled:opacity-50"
//           >
